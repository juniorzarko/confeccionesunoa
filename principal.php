      ...
      <div class="row">
             ...
             <h4 class="text-primary text-center "> Modulo Nomina</h4>	
              ...
              <div class="btn-group d-grid gap-2 mt-2" role="group">
                  ...
                  <ul class=" dropdown-menu" aria-labelledby="btnGroupDrop1">
                    ...
                    <li><a class="btn btn-link dropdown-item" onClick="desplegarlote();" href="#">Creacion de Lotes</a></li>
                    <li><a class="btn btn-link dropdown-item" onClick="desplegarusuarios();" href="#">Creacion de Operación</a></li>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-9 px-md-4"> 
          <div class="container">
            ...
            <div class="container">
             Div de Informacion de registros
            </div>
