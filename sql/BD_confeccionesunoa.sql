...
--
-- Servidor: localhost
-- Tiempo de generación: 15-11-2021 a las 20:14:53
...
ALTER TABLE `tb_transaccionesAPP`
  ADD KEY `id_usaurio` (`id_usaurio`,`id_modulo`),
  ADD KEY `id_modulo` (`id_modulo`);
...
--
ALTER TABLE `tb_transaccionesAPP`
  ADD CONSTRAINT `tb_transaccionesAPP_ibfk_1` FOREIGN KEY (`id_usaurio`) REFERENCES `tb_usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
