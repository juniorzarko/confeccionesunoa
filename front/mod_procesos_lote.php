<div class="container shadow bg-transparent rounded ">
  ...
  <div class="container flex p-2 ">
    <form class="needs-validation novalidate gx-3 ">
      <div class="col-md-12"> <h2 class="text-center">Entrada de trabajos de lotes</h2> </div> 
      <div class="row"> 
      ...
      <div class="row">           
        ...
        <div class="col-md-4 mx-auto mt-2">
            <div class="input-group">
                ...
                <input type="number" class="form-control " id="cantidad" placeholder="Asigne cantidad">    
            </div>
          </div>         
         </div>
      <div class="row">
    ...
    <nav class="navbar navbar-light bg-light">
      <form class="container-fluid justify-content-center">
        ...
        <button class="btn btn-sm btn-outline-primary" type="button">Guardar Entrada</button>
      </form>
    </nav>
  </div>    
                        ...
                        <div class="col-auto">
                          <div class="input-group">
                            <span><svg class="bi text-primary mt-2 m-2" width="16"      height="16" fill="currentColor">
                              ...
                              <section id="barSection"><div>display();</div></section>                     
                          </div>                
                        </div>
                        <div class="col-auto">
                          <div class="input-group">
